...
Project C's mandatory operational-truth and preflight scripts still read legacy product-context directly. A real v5 writer cutover requires an executable reader transition, plus an explicit checkpoint/restart of OBS-001. Source normalization does not resolve those constraints.

Project A retains WIP=1, independent review, local-only and protected-resource boundaries. Its successful synthetic vault check does not establish hybrid/vector readiness, production-vault restoration, or approval to launch deferred cloud/research work. The BDD failures stay visible.

Project B's 161 plan diagnostics were resolved individually (160 historical references and topology), with the generated/reviewed plans and resolution ledger retained. It preserves 2,176 source files, keeps L41-006b blocked and L41-006a2 imported/unverified, and enforces independent review. Repeat apply is a no-op. Project B retains owner decisions and production journey gates. Its broad dependency closure is itself a usability finding: a small requested migration scope need not produce a small import. Historical completed labels remain unverified, and missing source-origin decisions remain blockers. The YAML-based input reader rejected JSON surrogate escapes during plan authoring; literal UTF-8 serialization worked and is recorded as a remaining input-compatibility limitation.

## Evidence locations

Full local command transcripts and before/after manifests are retained in the pilot evidence directories. Durable reports: [Project A](evidence/2026-09-10-project-a-pilot.md), [Project C](evidence/2026-09-10-project-c-pilot.md), [Project B](evidence/2026-09-10-project-b-pilot.md). Earlier candidate hashes identify the exact binary used at each step; final rechecks are recorded separately rather than retroactively attributing all observations to one build.

- Project A: `/tmp/aep-project-a-pilot-rly6kn3y/evidence`, isolated repository `/tmp/aep-project-a-pilot-rly6kn3y/Project A`.
- Project B: `/tmp/aep-project-b-preview-20260910`, initial failure `/tmp/aep-project-b-migrate-plan-result.json`, retained-asset retry `/tmp/aep-project-b-assets-retry.json`.
- Project C: `/tmp/aep-project-c-pilot-ga18j4vs/evidence`, isolated repository `/tmp/aep-project-c-pilot-ga18j4vs/repo`.
