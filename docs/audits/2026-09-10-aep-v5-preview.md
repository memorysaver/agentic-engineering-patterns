...
Local artifact directory: `/tmp/aep-preview-release-uqtkfv0t`. Archive SHA-256: `5c503c22e97a62289bd397e8cd93f64631ac3df343bcc22e114ff838493b5060`. Its `candidate-manifest.json` binds every build input and binary digest. This is a prepared local candidate; no public tag or release has been created.

Final-candidate Linux/macOS CI is tracked on [PR #35](https://github.com/memorysaver/agentic-engineering-patterns/pull/35); prior runs for `34e5b9a` do not certify this preview. The downstream target has not been selected. The [trial guide](../workflow/aep-v5-preview-trial.md) is ready for a selected project's actual rules, active consumers, context and checks.
