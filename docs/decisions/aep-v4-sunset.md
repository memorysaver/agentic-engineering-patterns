...
5. Sunset 的完成條件：downstream 專案（目前為 Project A、project-b、Project C）都在 v5 上完成至少一次交付，且 v5 stable 已發布。屆時把 v4 的安裝說明從 README 移到 `docs/workflow/aep-v4.1-guide.md`，並在 marketplace 標註停止維護；不刪除 tag、分支或文件。
