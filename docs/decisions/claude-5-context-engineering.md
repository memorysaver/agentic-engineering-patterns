...
| **C-P4 — description budget (C3)** | Diet to 3,369 characters, re-recorded routing evals, CI cap to 3,400. De-advertising existing skills — and the router — are dropped per the C3 amendment (a new skill may still be born user-typed-only)                                              | **Routing metadata** — the risk phase |
