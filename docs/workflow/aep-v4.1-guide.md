...
- [Autonomous Loop](autonomous-loop.md) — how `/aep-autopilot` orchestrates the full cycle
- [Generator/Evaluator Data Flow](gen-eval-data-flow.md) — the three tracking systems and signal protocol
...
- [Release Line Adjustments](../decisions/release-line-adjustments.md) — when and how to re-slice layers
