...
The rules for authoring skills live in `docs/decisions/skill-authoring-standard.md` (R1–R9), `docs/decisions/claude-5-context-engineering.md` (C1–C6), and `docs/decisions/fable-5-1-behavioral-rebaseline.md` (F1–F6). Read them before editing anything under `skills/`. This file is the short form: what each rule means day to day and which check enforces it.
