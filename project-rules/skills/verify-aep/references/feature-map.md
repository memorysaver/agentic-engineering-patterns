...
| --- | --- | --- | --- |
| Discover native guidance | `aep skills --json`, then `skills show project`, `design --ref prototype`, `validate --ref self-verification` | Eight native entries with version/digest; complete content available outside source checkout | Selection by a cold agent is observed separately |
