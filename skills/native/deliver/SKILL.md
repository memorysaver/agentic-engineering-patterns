...
Read [Closure](references/closure.md) before cleaning resources or completing handoff. Use `aep skills show reflect` for useful observations. Report integration identity, actual verification scope, retained evidence and remaining resources or gaps.
