...
Each layer is a complete, testable, deployable increment. Layer 0 is the walking skeleton. Each subsequent layer adds capabilities. Most MVPs need 2–4 layers. More than that suggests scope is too large.
